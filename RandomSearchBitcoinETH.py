...
with open("BtcEthList.txt","r") as m: #Your Address List mix of addresses
    add = m.read().split()
add= set(add)
...
def seek(r):
        while True:
            ...
            if eaddr in add:
                ...
                colour_reset = '\033[0;0;39m'
                colour_red = '\033[31m'
                print ("\n " + colour_cyan + " RandomSearchBitcoinETH -----" + colour_red + " Random Search for Bitcoin and ETH Puzzle Wallets " + colour_cyan + "----- RandomSearchBitcoinETH "  + colour_reset) # Running Display Output
                print (myhex)
                print (caddr)
                print (uaddr)
                print (saddr)
